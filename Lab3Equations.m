...
% Input velocities (from the road)
...
% Constants
a = Lcg_1;  % Distance from the center of gravity to the front axle
b = L_wb - a;  % Distance from the center of gravity to the rear axle
...
q_tf_dot = v_fi - (p_tf / m_tf);  % Front tire velocity change (based on input velocity)
q_tr_dot = v_ri - (p_tr / m_tr);  % Rear tire velocity change (based on input velocity)
...
% Road input velocity function (square wave)
